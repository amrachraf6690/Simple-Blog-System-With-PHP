...
echo '
                    ...
                    <td>'.$date.'</td>
                    <td><a href="edit.php?id='.$row['id'].'"<button class="btn btn-success">Edit</button></a> | <a href="delete-post.php?id='.$row['id'].'"<button class="btn btn-danger">Delete</button></a></td>
                    </tr>
                    ';}?>  
